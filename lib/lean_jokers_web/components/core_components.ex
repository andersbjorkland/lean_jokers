defmodule LeanJokersWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LeanJokersWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LeanJokersWeb.Gettext, "errors", msg, opts)
    end
  end
